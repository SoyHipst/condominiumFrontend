 ...
 <div class="header bg-primary pt-5 pb-7">
    <div class="container">
        <div class="header-body">
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="pr-5">
                <h1 class="display-2 text-white font-weight-bold mb-0">Komun.app</h1>
                <h2 class="display-4 text-white font-weight-light">Web</h2>
                <p class="text-white mt-4">Movil</p>
                <div class="mt-5">
                  <a href="#" class="btn btn-neutral my-2">Explore</a>
                  <a href="https://www.creative-tim.com/product/argon-dashboard-pro" class="btn btn-default my-2">Buy now</a>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
                ...
                <div class="col-md-6">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <h5 class="h3">Locations</h5>
                      <p>integrated and extendable.</p>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-4">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    ...
                    <h4 class="h3 text-primary text-uppercase">Based</h4>
                    <p class="description mt-3">the most popular open source.</p>
                    <div>
                      <span class="badge badge-pill badge-primary">About</span>
                      <span class="badge badge-pill badge-primary">Services</span>
                      <span class="badge badge-pill badge-primary">Location</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    ...
                    <h4 class="h3 text-success text-uppercase">Integrated tools</h4>
                    <p class="description mt-3">included npm and gulp scripts.</p>
                    <div>
              ...
              <div class="col-lg-4">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    ...
                    <p class="description mt-3"> customization easier.</p>
                    <div>
      ...
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6 order-md-2">
            <img src="<?php echo e(asset('img/theme/landing-1.png')); ?>" class="img-fluid">
          </div>
          <div class="col-md-6 order-md-1">
            <div class="pr-md-5">
              <h1>features</h1>
              <p>This dashboard comes with super cool features and functional widgets are just a few things you will see and love at first sight.</p>
              <ul class="list-unstyled mt-5"></ul>
                <li class="py-2">
                ...
                <li class="py-2">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h4 class="mb-0">Amazing examples</h4>
                    </div>
                  </div>
                </li>
                <li class="py-2">
    ...
    <section class="py-6">
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6">
            <img src="<?php echo e(asset('img/theme/landing-2.png')); ?>" class="img-fluid">
          </div>
          <div class="col-md-6">
            <div class="pr-md-5">
              <h1>Example pages</h1>
              ...
              <a href="#" class="font-weight-bold text-warning mt-5">Explore pages</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="py-6">
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6 order-md-2">
            <img src="<?php echo e(asset('img/theme/landing-3.png')); ?>" class="img-fluid">
          </div>
          <div class="col-md-6 order-md-1">
            <div class="pr-md-5">
              ...
              <a href="#" class="font-weight-bold text-info mt-5">Explore widgets</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <div class="btn-wrapper">
              <a href="#" class="btn btn-primary">View demo icons</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\condominium\resources\views/welcome.blade.php ENDPATH**/ ?>